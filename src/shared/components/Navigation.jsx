...
const Navigation = () => {
    ...
    return (
        <>
            <nav
                className={`fixed top-0 left-0 w-full flex justify-between items-center z-50 pointer-events-none transition-all duration-500 ease-out ${
                    hasScrolled
                        ? "px-6 py-4 bg-[var(--color-surface-strong)] backdrop-blur-xl border-b border-[var(--color-border)] text-primary mix-blend-normal shadow-lg"
                        : "px-6 py-6 text-white mix-blend-difference"
                }`}
            >
                <a
                    href="#"
                ...
                <div className="hidden md:flex items-center gap-1 pointer-events-auto bg-[var(--color-surface)] backdrop-blur-md px-1.5 py-1.5 rounded-full border border-[var(--color-border)]">
                    <a
                        href="#about"
                        className="px-5 py-2 rounded-full font-mono text-[10px] uppercase tracking-widest hover:bg-[var(--color-surface-strong)] transition-colors"

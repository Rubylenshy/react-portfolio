      ...
      >
          ...
          <div className="flex flex-col lg:flex-row items-center lg:items-start gap-10 lg:gap-16 mx-auto max-w-6xl">
              ...
              <div className="flex items-center lg:items-start gap-4 lg:gap-6">
                  <div className="magnetic-btn max-h-fit max-w-fit inline-flex items-center justify-center rounded-full border border-[var(--color-border-strong)] p-[3px] transition duration-300">
                      <img
                  ...
                  <div className="flex flex-col">
                      ...
                      <h3 className="text-4xl md:text-5xl lg:text-6xl font-semibold tracking-tight text-primary leading-[1.05]">
                          Engineering
                          <br />
              ...
              <div className="flex-1 items-center lg:items-start w-full space-y-8">
                  <p className="text-sm md:text-base text-secondary leading-7 md:leading-8 font-light max-w-xl">
                      I'm a{" "}
                  ...
                  <div className="flex flex-wrap lg:flex-nowrap gap-6 md:gap-10">
                      ...
                      <div className="h-10 w-px bg-[var(--color-border)] hidden md:block"></div>
                      <div className="flex flex-col min-w-[120px]">
                          <span className="text-3xl font-semibold text-primary">
                              6+
                          </span>

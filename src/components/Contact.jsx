...
const Contact = () => {
  const socialLinks = [
    ...
    { icon: 'fa-solid fa-envelope', href: 'mailto:reztomoloju@gmail.com', label: 'Email' },
  ...
  return (
    <section id="contact" className="px-6 pt-24 pb-12 md:py-40 md:py-20 bg-[#030303] relative overflow-hidden">
      {/* Abstract Decoration */}
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-6">
          <a
            ...
            className="group relative px-8 py-4 bg-white text-black rounded-sm font-mono text-xs uppercase font-bold tracking-widest hover:scale-105 hover:border hover:border-white hover:text-white hover:bg-transparent transition-transform duration-300 overflow-hidden"
          >
            <span className="relative z-10">hello@reuben.dev</span>
          </a>
        ...
        <div className="mt-24 grid grid-cols-2 md:grid-cols-3 gap-8 text-left border-t border-white/10 pt-12">
          <div>
            <h4 className="font-mono text-[10px] uppercase text-gray-500 mb-4">Location</h4>
            <p className="text-sm font-medium text-white">Ibadan, Nigeria</p>
            <p className="text-sm text-gray-400">Remote Worldwide</p>
          </div>
          <div>
            <h4 className="font-mono text-[10px] uppercase text-gray-500 mb-4">Focus</h4>
            <p className="text-sm font-medium text-white">Backend Developmentv</p>
            <p className="text-sm text-gray-400">Design Systems</p>
          </div>
          <div>
            <h4 className="font-mono text-[10px] uppercase text-gray-500 mb-4">Socials</h4>
